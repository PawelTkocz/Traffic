...
from CarDrafter import CarDrafter
...
class Car:
    ...
    def __init__(self, width, length, front_left_pos, direction, wheels_max_turn, *, color):
        ...
        if direction.x == 0 and direction.y == 0:
            ...
            self.direction = Vector(direction.x, direction.y).normalize(False)
    ...
    def draw(self, screen):
        ...
        self.car_drafter.draw(corners, self.wheels.cur_angle(), self.cur_turn_side(), screen)
